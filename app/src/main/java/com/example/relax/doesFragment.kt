 ...
 */
class doesFragment(uid : String) : Fragment(R.layout.fragment_chat) {
    public val uid = uid
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val ref = FirebaseDatabase.getInstance().getReference("Messages").child("does")
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    val adapter2 = adapter(tudulist,uid,"does")
        ...
        sendBtn.setOnClickListener {
            ...
            val user = mdb.getReference("Messages").child("does")
